...
def get_demo_data() -> dict[str, Rendicion]:
    ...
    return {
        "TX-001": {
            ...
            "observaciones": [],
            "historial": [
                {"estado": "Borrador",   "actor": "Tomás Alarcón", "fecha": "2025-05-12 09:10", "nota": "Rendición creada"},
                {"estado": "Pendiente",  "actor": "Sistema",             "fecha": "2025-05-12 09:14", "nota": "Validaciones OK. Notificada supervisora."},
                {"estado": "Aprobado",   "actor": "Camila Fuentes",    "fecha": "2025-05-12 11:30", "nota": "Pertinencia operativa confirmada."},
        ...
        "TX-002": {
            ...
            "historial": [
                {"estado": "Borrador",  "actor": "Tomás Alarcón", "fecha": "2025-05-12 09:18", "nota": "Rendición creada"},
                {"estado": "Pendiente", "actor": "Sistema",             "fecha": "2025-05-12 09:20", "nota": "Validaciones OK."},
                {"estado": "Aprobado",  "actor": "Camila Fuentes",    "fecha": "2025-05-12 11:35", "nota": "Pertinencia operativa confirmada."},
        ...
        "TX-003": {
            ...
            "observaciones": [],
            "historial": [
                {"estado": "Borrador",        "actor": "Tomás Alarcón", "fecha": "2025-05-13 07:55", "nota": "Rendición creada"},
                {"estado": "Pendiente",       "actor": "Sistema",             "fecha": "2025-05-13 08:00", "nota": "Validaciones OK. Notificada supervisora."},
                {"estado": "Aprobado",        "actor": "Camila Fuentes",    "fecha": "2025-05-13 09:10", "nota": "Equipo corresponde al proyecto de faena."},
        ...
        "TX-004": {
            ...
            "observaciones": [],
            "historial": [
                {"estado": "Borrador",      "actor": "Tomás Alarcón", "fecha": "2025-05-13 08:08", "nota": "Rendición creada"},
                {"estado": "Pendiente",     "actor": "Sistema",             "fecha": "2025-05-13 08:10", "nota": "Validaciones OK."},
                {"estado": "Aprobado",      "actor": "Camila Fuentes",    "fecha": "2025-05-13 09:20", "nota": "Gasto de transporte pertinente."},
        ...
        "TX-005": {
            ...
            "historial": [
                {"estado": "Borrador",   "actor": "Tomás Alarcón", "fecha": "2025-05-09 13:55", "nota": "Rendición creada"},
                {"estado": "Pendiente",  "actor": "Sistema",             "fecha": "2025-05-09 14:00", "nota": "Validaciones OK."},
                {"estado": "Rechazado",  "actor": "Camila Fuentes",    "fecha": "2025-05-09 16:00", "nota": "Gasto no corresponde a actividad laboral de la empresa."},
            ],
            "intentos_correccion": 0,
        },
    }
